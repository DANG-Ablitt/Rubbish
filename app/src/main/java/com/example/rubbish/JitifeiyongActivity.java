...
//import com.codbking.widget.DateUtils;
...
public class JitifeiyongActivity extends AppCompatActivity {
        ...
        mfancyCoverFlow.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (homeFancyCoverFlow != null) {
                    //Toast.makeText(JitifeiyongActivity.this,homeFancyCoverFlow.getName(),Toast.LENGTH_SHORT).show();
    ...
    private View.OnClickListener l = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.ettime:
                    DatePickDialog dialog = new DatePickDialog(JitifeiyongActivity.this);
                    //设置上下年分限制
    ...
    private void Getdata()
    {
        ...
        String url = String.format(URLconfig.URL_BOOT + URLconfig.URL_JITIGOUMAI);
                ...
                new Response.Listener<JSONObject>()
                {
                    ...
                    public void onResponse(JSONObject response)
                    {
                        ...
                        try {
                            ...
                            {
                                Toast.makeText(JitifeiyongActivity.this, "购买成功 请您尽快付款", Toast.LENGTH_SHORT).show();
                            }
                            else
                            {
                                Toast.makeText(JitifeiyongActivity.this, "购买失败 请您检查网络", Toast.LENGTH_SHORT).show();
                            }
